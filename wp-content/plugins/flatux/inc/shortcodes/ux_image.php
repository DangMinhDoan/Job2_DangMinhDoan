...
function flatux_image_shortcode( $atts, $content = null ) {
   ...
   if($box_hover) wp_enqueue_style( 'flatux-hover');
    ...
    if($animatecss) $classes_inner[] = 'animated '.$animatecss;
  	if($animatecss_infinite) $classes_inner[] = 'infinite';
	...
	<div class="img has-hover <?php echo $classes; ?>" id="<?php echo $_id; ?>">
		...
		<?php if ( $box_hover ) echo '<div class="hvr-'.$box_hover.'">'; ?>
...
add_shortcode( 'flatux_image', 'flatux_image_shortcode' );
